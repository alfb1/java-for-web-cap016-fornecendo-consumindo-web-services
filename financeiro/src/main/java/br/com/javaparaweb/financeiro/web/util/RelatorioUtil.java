...
public class RelatorioUtil 
{
   ...
   public StreamedContent geraRelatorio( HashMap parametroRelatorio,
		                                 ...
		                                 int tipoRelatorio ) throws UtilException
   {
	   ...
	   try {
		   ...
		   // path in windows : "\relatorios" path in linux : "/relatorios"
		   ...
		   JasperDesign jasperDesign    = JRXmlLoader.load(caminhoArquivoJasper);
	   ...
	   {
		   throw new UtilException( "Arquivo do relatório não foi encontrado.", e );
	   }
   ...
   private Connection getConexao() throws UtilException 
   {
	   try {
		   ...
		   javax.sql.DataSource ds = (javax.sql.DataSource) envContext.lookup("FinanceiroDB");
